...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/Dewalla/BERAK")
...
# Untuk Perintah .debot (alive)
RAM_TEKS_KOSTUM = os.environ.get("RAM_TEKS_KOSTUM") or "ㅤ"

# Untuk Melihat Repo
REPO_NAME = os.environ.get("REPO_NAME") or "𖣔𝗕𝗘𝗥𝗔𝗞𖣔"
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "BERAK")
...
GROUP_LINK = os.environ.get(
    "GROUP_LINK") or "t.me/kalongclub"

# Default .repo Bot
OWNER_BOT = os.environ.get(
    "OWNER_BOT") or "t.me/dewaslow"


# Last.fm Module
BIO_PREFIX = os.environ.get("BIO_PREFIX", None)
DEFAULT_BIO = os.environ.get("DEFAULT_BIO") or "𖣔𝗕𝗘𝗥𝗔𝗞𖣔"
...
BOTLOG_MSG = os.environ.get(
    "BOTLOG_MSG") or "```║UDEH AKTIF YA KONTOLL𓂺𓂺║\n\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\nJika Tidak Bisa Di .ping\nSilahkan Anda\nCek viewlogs\nPada heroku Anda.\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰```"
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**⭐BERAK⭐ v{BOT_VER} Sedang berjalan!**\n\n"
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@Ram_ubot"):
                ...
                result = builder.article(
                    title="Repository",
                    description="Repository ✨BERAK✨",
                    url="https://t.me/geezsupportgroup",
                    text="**⭐BERAK⭐**\n➖➖➖➖➖➖➖➖➖➖\n✨ **Owner :** [DEWALA](https://t.me/dewaslow)\n✨ **Support :** @geezsupportgroup\n✨ **Repository :** [⭐BERAK⭐](https://github.com/Dewalla/BERAK)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
