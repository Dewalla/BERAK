    ...
    if HEROKU_API_KEY is not None:
        ...
        if HEROKU_APP_NAME is None:
            await event.edit(
                ...
                ' untuk dapat deploy perubahan terbaru dari BERAK.`'
            )
            repo.__del__()
            return
        ...
        if heroku_app is None:
            await event.edit(
                f'{txt}\n`Kredensial Heroku tidak valid untuk deploy BERAK dyno.`'
            )
            return repo.__del__()
...
CMD_HELP.update({
    'update':
    ".update"
    "\nUsage: Untuk Melihat Pembaruan Terbaru BERAK."
    "\n\n.update one"
    "\nUsage: Memperbarui BERAK."
    "\n\n.update all"
    "\nUsage: Memperbarui BERAK Dengan Cara Deploy Ulang."
})
