...
async def typewriter(typew):
    ...
    await typew.edit("`\n(\\_/)`"
                     "`\n(●_●)`"
                     "`\n/>💔  *EH GAK DEH,UDH DI KSH GRATIS LU RUSAKIN`")
    sleep(2)
    await typew.edit("`\n(\\_/)`"
                     "`\n(●_●)`"
                     "`\n💔<\\  *ANJING`")
...
async def _(event):
    ...
    if input_str == "owner":
        ...
        animation_chars = [
            "**OWNER BERAK ADALAH MANUSIA TERGANTENG DI HATI PEMAKAI NYA, KENALAN DULU SAMA OWNER NYA YUK**"
            "**DEWALA NAMANYA,ORANG NYA BAIK**"
